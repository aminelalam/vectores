...
See the [open issues](https://github.com/your_username/rag-semantic-search/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/your_username/rag-semantic-search](https://github.com/your_username/rag-semantic-search)
